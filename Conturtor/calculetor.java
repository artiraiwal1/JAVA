...
class CalculatorOpretion
{
	...
	public double pow(CalculatorPOJO ob)
	{
		double pow=1;
		for(int i=1;i<=ob.getB();i++)
		{
			pow=pow*ob.getA();
		}
		return pow;
	}
	public double squ(CalculatorPOJO ob)
	{
		return ob.getA()*ob.getA();
	}
	public double qube(CalculatorPOJO ob)
	{
		return ob.getA()*ob.getA()*ob.getA();
	}
}
...
class Test
{
	...
	public static void main(String args[])
	{
		...
		do{
			...
			System.out.println("\t15 number of power :");
			System.out.println("\t16 number of square :");
			System.out.println("\t17 number of Qube :");
			...
			switch(ch)
			{
				...
				case 17 :
					...
					ob1.input(ob);
					ans=cl.qube(ob);
					System.out.println("Qube is :"+ans);
					break;   
			}
